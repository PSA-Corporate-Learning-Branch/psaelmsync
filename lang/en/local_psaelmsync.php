...
$string['fieldmapping_desc'] = 'Configure which API field names map to each internal concept. Use the discovery tool to fetch field names from the live API.';
...
$string['mapping_activity_id'] = 'Activity ID';
$string['mapping_col_apifield'] = 'API field name';
$string['mapping_col_concept'] = 'Plugin concept';
$string['mapping_col_required'] = 'Required';
$string['mapping_completion_desc'] = 'When posting completion data back to the API, these field names are used as keys in the JSON payload.';
$string['mapping_completion_extra'] = 'Completion-only fields';
$string['mapping_completion_heading'] = 'Completion (outbound) field mapping';
$string['mapping_completion_shared'] = 'Shared fields';
$string['mapping_completion_shared_desc'] = 'These fields are shared with the intake mapping. If the completion API uses different field names, override them here.';
$string['mapping_course_complete_date'] = 'Course completion date';
$string['mapping_course_identifier'] = 'Course identifier (maps to Moodle course idnumber)';
$string['mapping_course_long_name'] = 'Course long/full name';
$string['mapping_course_shortname'] = 'Course shortname / class code';
$string['mapping_course_state'] = 'Course state (Enrol / Suspend / Complete)';
$string['mapping_course_state_date'] = 'Course state date';
$string['mapping_date_created'] = 'Record creation date';
$string['mapping_discover_btn'] = 'Fetch sample record from API';
$string['mapping_discover_curlerror'] = 'cURL error fetching from API: ';
$string['mapping_discover_desc'] = 'Fetch a sample record from the configured enrolment API to discover available field names. This will help you configure the field mapping below.';
$string['mapping_discover_found'] = '{$a} fields discovered:';
$string['mapping_discover_heading'] = 'API field discovery';
$string['mapping_discover_httperror'] = 'API returned HTTP error: ';
$string['mapping_discover_noconfig'] = 'Enrolment API URL and token must be configured before discovering fields.';
$string['mapping_discover_norecords'] = 'API returned no records. Cannot discover field names from an empty response.';
$string['mapping_discover_success'] = '{$a} fields discovered from the API. Use the dropdowns below to map them.';
$string['mapping_email'] = 'User email address';
$string['mapping_enrolment_id'] = 'Enrolment ID';
$string['mapping_first_name'] = 'User first name';
$string['mapping_guid'] = 'User GUID (maps to Moodle user idnumber)';
$string['mapping_intake_desc'] = 'Map API response field names to the internal concepts the plugin uses for enrollment processing. Required fields must be mapped for the sync to function.';
$string['mapping_intake_heading'] = 'Intake (inbound) field mapping';
$string['mapping_last_name'] = 'User last name';
$string['mapping_not_mapped'] = 'Not mapped';
$string['mapping_oprid'] = 'OPRID / IDIR identifier';
$string['mapping_optional'] = 'Optional';
$string['mapping_person_id'] = 'Person ID / Learner ID';
$string['mapping_record_enrol_id'] = 'Record enrol ID (high-water mark / sequential ID)';
$string['mapping_required'] = 'Required';
$string['mapping_reset'] = 'Reset to defaults';
$string['mapping_reset_success'] = 'Field mappings have been reset to defaults.';
$string['mapping_save'] = 'Save mapping';
$string['mapping_save_missing'] = 'The following required fields must be mapped:';
$string['mapping_save_success'] = 'Field mappings saved successfully.';
$string['mapping_user_effective_date'] = 'User effective date';
$string['mapping_user_state'] = 'User state (Active / Inactive)';
